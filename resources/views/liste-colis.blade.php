                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Liste des colis</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <td>{{ $donnee['id'] }}</td>
                                                ...
                                                <td>{{ $donnee['quantité'] }}</td>
                                                <td>{{ $donnee['prix'] }}</td>
                                                <td>{{ $donnee['nom'] }}</td>
                                                <td>{{ $donnee['email'] }}</td>
                                                <td>{{ $donnee['adresse'] }}</td>
                                                <td>{{ $donnee['tél'] }}</td>
                                                <td>{{ $donnee['confirmé'] }}</td>
                                                <td>
                                                    <a href="/modif-colis"><button type="button" class="btn btn-primary">Modifier</button></a>
                                                    <a onclick="return confirm('voulez-vous vraiment supprimer le colis de {{$donnee['nom']}}')" href="/deleteColis/{{$donnee['id']}}" class="btn btn-danger">Supprimer</a>
                                                    <a href="/invoice"><button type="button" class="btn btn-secondary">PDF</button></a>
                                                    <button type="button" class="btn btn-success">Payé</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
