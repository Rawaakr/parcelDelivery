                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">                        
                                <ol class="breadcrumb-menubar list-inline">
                                    <li><a href="#" class="gray-clr">Accueil</a></li>                                   
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-md-offset-1">
                                <ul class="contact-detail title-2 pt-50">
                                    <li class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".30s"> <span>Tél:</span> <p class="gray-clr"> +216-25-103-466 </p> </li>
                                </ul>
                                <ul class="contact-detail title-2 pt-50">
                                    <li class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".30s"> <span>Adressemail:</span> <p class="gray-clr"> deliverymolka@gmail.com <br>
contact@mokladelivery.com
 </p> </li>
                                </ul>
                            </div>
