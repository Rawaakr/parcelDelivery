                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <br>
                                        <form action="/editAdmin" method="post"></form>
                                            @csrf
                                                <input type="text" hidden name="id" value="{{$donnees['id']}}">
                                                <div class="row mb-3">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Nom</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" placeholder="nom" name="name" value="{{$donnees['name']}}" id="example-text-input">
                                                    </div>
                                                </div>
                                                <label for="example-text-input" class="col-sm-2 col-form-label">prenom</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" placeholder="nom" name="prenom" value="{{$donnees['prenom']}}" id="example-text-input">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" placeholder="Login" name="login" value="{{$donnees['login']}}" id="example-text-input">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="Email" placeholder="email@gmail.com" name="email" value="{{$donnees['email']}}" id="example-text-input">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="Password" placeholder="*****" name="password" value="{{$donnees['password']}}" id="example-text-input">
                                                    </div>
                                                </div>
