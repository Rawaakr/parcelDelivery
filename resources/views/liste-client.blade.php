                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $donnee['tél'] }}</td>
                                                <td>
                                                    <a href="/modif-client"><button type="button" class="btn btn-primary">Modifier</button></a>
                                                    <a onclick="return confirm('voulez-vous vraiment supprimer le client {{$donnee['name']}}')" href="/deleteClient/{{$donnee['id']}}" class="btn btn-danger">Supprimer</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
