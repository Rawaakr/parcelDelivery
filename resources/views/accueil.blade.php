                    ...
                    <div class="theme-container container">
                        <div class="row">
                            <div class="col-md-6 col-sm-7 fs-12">
                                <p class="contact-num">  <i class="fa fa-phone"></i> Appelez-nous maintenant: <span class="theme-clr"> +216-25-103-466 </span> </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="theme-container container">
                        <div class="row">
                            <div class="col-md-2 col-sm-2">
                                ...
                                <a class="navbar-logo" href="#"> <img src="{{url('img/logo.png')}}" alt="logo" /> </a>
                            </div>
                            <div class="col-md-10 col-sm-10 fs-12">
                                <div id="navbar" class="collapse navbar-collapse no-pad">
                                    <ul class="navbar-nav theme-menu">
                                        ...
                                        <li> <a href="/contact-front"> contact </a> </li>  
            ...
            <article> 
                ...
                <section class="banner mask-overlay pad-120 white-clr">
                    <div class="container theme-container rel-div">
                        <img class="pt-10 effect animated fadeInLeft" alt="" src="{{url('assets/img/icons/icon-1.png')}}" />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="about-us">
                                    ...
                                    <p class="fs-16 wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s">STE MOLKA DELIVERY est une société de livraison des colis à domicile située à AV LA REVOLUTION MENZEL TEMIME 8080 , en exclusivité.
<br>
<br>
Notre affaire est de vous aider à livrer vos produits vendus en ligne, en marché et/ou dans vos boutiques points de ventes.
<br>
<br>
Pour faciliter votre force de vente dans le marché et afin de participer à votre succès nous mettons à votre disposition un service exceptionnel, un suivi particulier, et une méthode de travail qui va vous intégrer de plus en plus dans le domaine de vente en ligne.</p>
                                    <ul class="feature">
                                        <li> 
                                            <img alt="" src="{{url('assets/img/icons/icon-2.png')}}" class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s" /> 
                                        ...
                                        <li> 
                                            <img alt="" src="{{url('assets/img/icons/icon-3.png')}}" class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s" /> 
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                            ...
                            <div class="col-md-6 text-center">
                                ...
                                <img alt="" src="{{url('img/about-img.png')}}" class="wow slideInRight" data-wow-offset="50" data-wow-delay=".20s" />
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                ...
                                <div class="steps-content wow fadeInLeft" data-wow-offset="50" data-wow-delay=".25s"> 
                                    <p class="gray-clr">STE MOLKA DELIVERY est une société de livraison des colis à domicile</p>                                            
                                </div>  
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <div class="font-2 fs-50 wow fadeInLeft" data-wow-offset="50" data-wow-delay=".20s"> 2. </div> 
                                <div class="steps-content wow fadeInLeft" data-wow-offset="50" data-wow-delay=".25s"> 
                                    <p class="gray-clr">Nous sommes les premiers et en exclusivité dans la région de Menzel temime</p>                                            
                                </div>  
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <div class="font-2 fs-50 wow fadeInLeft" data-wow-offset="50" data-wow-delay=".20s"> 3. </div> 
                                <div class="steps-content wow fadeInLeft" data-wow-offset="50" data-wow-delay=".25s">  
                                    <p class="gray-clr">Nous sommes la pour vous intégrer dans le domaine de vente en ligne et de vous mettre plus proche de vos clients.. Votre succès est notre affaire</p>                                            
                                </div>  
                            </div>
                        </div>
                    </div>
                    <div class="step-img wow slideInRight" data-wow-offset="50" data-wow-delay=".20s"> <img src="{{url('assets/img/block/step-img.png')}}" alt="" /> </div>
                </section>
                <!-- /.Steps -->
                        ...
                        <div class="row">
                            <div class="col-md-11 col-md-offset-1">
                                <div class="pt-120 rel-div">
                                    ...
                                    <h2 class="section-title wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s"> Nous sommes à votre disposition </h2>
                                    <p class="fs-16 wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s">Molka delivery est la plus rapide</p>
                                    <div class="pb-120 hidden-xs"></div>
                                </div>
                                <div class="delivery-img pt-10">
                                    <img alt="" src="{{url('assets/img/block/delivery.png')}}" class="wow slideInLeft" data-wow-offset="50" data-wow-delay=".20s"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="testimonial-slider no-pagination pad-120">
                            <div class="item">
                                <div class="testimonial-img darkclr-border theme-clr font-2 wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s">
                                    <img alt="" src="{{url('assets/img/block/testimonial-1.png')}}" />
                                    <span>,,</span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-8">
                                ...
                                <ul class="contact-detail title-2">
                                    ...
                                    <li class="wow slideInUp" data-wow-offset="50" data-wow-delay=".25s"> <span>Tel:</span> <p class="gray-clr"> +216-25-103-466 </p> </li>
                                    <li class="wow slideInUp" data-wow-offset="50" data-wow-delay=".30s"> <span>Adresse email:</span> <p class="gray-clr"> deliverymolka@gmail.com<br> contact@mokladelivery.com </p> </li>
                                </ul>
                            </div>                        
                        </div>
                    </div>               
                    ...
                    <div class="theme-container container">               
                        <div class="row">
                            <div class="col-md-3 col-sm-6 footer-widget">
                                <a href="#"> <img class="logo" alt="#" src="{{url('img/footerLogo.png')}}" />  </a>
                            </div>
                            <div class="col-md-3 col-sm-6 footer-widget">
                                <h2 class="title-1 fw-900">LIENS RAPIDES</h2>
                                <ul>
                            ...
                            <div class="col-md-3 col-sm-6 footer-widget">
                                <h2 class="title-1 fw-900">ENTRER EN CONTACT</h2>
                            ...
                            <div class="col-md-3 col-sm-6 footer-widget">
                                <h2 class="title-1 fw-900">FACEBOOK</h2>
                                <ul>
        ...
        <!-- Data binder -->
        <script src="{{url('assets/plugins/data.binder.js/data.binder.js')}}" type="text/javascript"></script>
