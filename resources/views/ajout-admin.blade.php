                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h1 class="card-title" style=" color: gray;font-weight: bold; font-size: 30px">Ajouter administrateur</h1>
                                        <br>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" placeholder="Login" id="example-text-input">
                                            </div>
                                        </div>
