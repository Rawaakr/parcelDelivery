                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h1 class="card-title" style=" color: gray;font-weight: bold; font-size: 30px">Modifier colis</h1>
                                        <br>
                                        
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Contenu</label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control" placeholder="Contenu"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" placeholder="quantité" id="example-text-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" placeholder="Prix" id="example-text-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" placeholder="12365478" id="example-text-input">
                                            </div>
                                        </div>
