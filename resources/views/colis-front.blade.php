...
<head>
    ...
    <body id="home">
        ...
        <main class="wrapper">
            ...
            <h2 class="section-title no margin" style="color:black">Liste colis</h2>
            </section>
            <div class="title-wrap">
            <a href="/ajoutcolis-front"><button class="btn btn-primary" style="position:absolute;right:60px">Ajouter colis</button></a>
            </div>
            <!-- Content Wrapper -->
            <article> 
