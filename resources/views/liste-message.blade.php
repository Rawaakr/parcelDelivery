                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href=""><button type="button" class="btn btn-primary">afficher</button></a>
                                                    <a onclick="return confirm('voulez-vous vraiment supprimer le message {{$donnee['nom']}}')" href="/deleteMessage/{{$donnee['id']}}" class="btn btn-danger">Supprimer</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
