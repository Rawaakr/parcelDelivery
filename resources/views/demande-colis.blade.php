                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $donnee['tél'] }}</td>
                                                <td>
                                                    <a href="/modif-client"><button type="button" class="btn btn-primary">PICK UP</button></a>
                                                    <button type="button" class="btn btn-secondary">confirmation de la livraison</button>
                                                    <button type="button" class="btn btn-secondary">Retour de la livraison</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
