...
<!-- Mirrored from themesdesign.in/nazox-ajax/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Oct 2021 21:46:50 GMT -->
<head>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-1 overflow-hidden">
                                                        <p class="text-truncate font-size-20 mb-2">Administrateur(s)</p>
                                                        <h4 class="mb-0">1452</h4>
                                                    </div>
                                                    <div class="text-primary ms-auto">
                                                    <a href="/liste-admin"><button class="btn btn-primary">Afficher</button> </a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-1 overflow-hidden">
                                                        <p class="text-truncate font-size-20 mb-2">Client(s)</p>
                                                        <h4 class="mb-0">2010</h4>
                                                    </div>
                                                    <div class="text-primary ms-auto">
                                                    <a href=""><button class="btn btn-primary">Afficher</button> </a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                <div class="flex-1 overflow-hidden">
                                                        <p class="text-truncate font-size-20 mb-2">Colis</p>
...
<!-- Mirrored from themesdesign.in/nazox-ajax/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Oct 2021 21:47:33 GMT -->
</html>